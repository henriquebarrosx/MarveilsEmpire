  ...
  return (
    <div className="relative">
      ...
      <main className="flex items-center justify-center h-screen">
        <form className="px-8 md:px-16 py-10 w-[90%] bg-[#242424] shadow-lg shadow-[#6C63FF] rounded-lg max-w-[460px] self-center flex-col border-2 border-solid border-[#6C63FF]">
